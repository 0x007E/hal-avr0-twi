...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/0x007E/hal-avr0-twi)
...
|:---------:|:------------------:|:-------------------------|
| Library   | [zip](https://github.com/0x007E/hal-avr0-twi/releases/latest/download/library.zip) / [tar](https://github.com/0x007E/hal-avr0-twi/releases/latest/download/library.tar.gz) | AVR0 `twi` library |
