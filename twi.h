 ...
 * 
 * @see https://github.com/0x007e/hal-avr0-twi "AVR0 TWI HAL GitHub Repository"
 */
...
#define TWI_H_
    ...
    #ifndef TWI_BITRATE_CALCULATION
        /**
            * @def TWI_BITRATE_CALCULATION
            ...
            */
        #define TWI_BITRATE_CALCULATION (unsigned char)(((float)F_PER)/(float)((F_TWI<<1)) - 5UL - ((unsigned int)(F_PER * (T_RISE))>>1))
    #endif
		 ...
		 *
         * @attention This setting is only applicable for ATmega microcontrollers with multiple pin mapping options for TWI.
         *
